...
class WelcomeViewController: BaseViewController {
    ...
    private lazy var tcomLabel: UILabel = {
        ...
        label.font = UIFont(name: "Arial-BoldMT", size: Dimensions.Fonts.small)
        return label
    }()
    ...
    private func setupViews() {
        ...
        welcomeTo.snp.makeConstraints { make in
            make.top.equalTo(tcomLabel.snp.bottom).offset(Dimensions.Inset.large)
            make.left.equalToSuperview().offset(Dimensions.Inset.medium)
            make.right.equalToSuperview().offset(-Dimensions.Inset.medium)
        }
        ...
        createANewLocationButton.snp.makeConstraints { make in
            make.top.equalTo(pathFinder.snp.bottom).offset(Dimensions.Inset.large)
            make.centerX.equalToSuperview()
        }
        
        openInMaps.snp.makeConstraints { make in
            make.top.equalTo(createANewLocationButton.snp.bottom).offset(Dimensions.Inset.medium)
            make.centerX.equalToSuperview()
        }
        
        compass.snp.makeConstraints { make in
            make.top.equalTo(openInMaps.snp.bottom).offset(Dimensions.Inset.medium)
            make.centerX.equalToSuperview()
        }
    }
